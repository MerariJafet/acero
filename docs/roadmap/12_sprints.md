...
| 11 | Scientific Reliability & Adversarial Assurance | ✅ Hecho | Gate universal in-line (contextvars async, tokens de mutación single-use, Unit of Work), grafo de dependencia de evidencia, calibración por dominio, red team (22 ataques) + mutation testing, reliability cards, readiness (techo human-review), Scientific Reliability Gauntlet 10/10 |
| 12 | Human Scientific Review & Local Publication Preparation | ✅ Hecho | Expediente revisable (evidencia + reliability + limitaciones + disclaimers), sign-off humano estructurado (comprensión + razón + hash de contenido, revisor no-IA), export LOCAL gated que nunca publica; Human Scientific Review Gauntlet 6/6 |
